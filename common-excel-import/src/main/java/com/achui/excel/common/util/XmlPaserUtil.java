 ...
 * 
 */
package com.achui.excel.common.util;
...
import com.achui.excel.common.entity.RowDefinition;
import com.achui.excel.excel.entity.ConvertKey;
import com.achui.excel.excel.entity.ExcelImportEntity;
...
public class XmlPaserUtil {
	...
	public static RowDefinition getRowDefinition(URL importCfg){
